...
int main(void)
{
	...
	/* create a message to be displayed on the VGA 
          and LCD displays */
	char text_top_row[50] = "XYZ Trading Portfolio\0";
	...
	VGA_text (64, 58, text_bottom_row);
	...
	while(1) 
	{
        // Plot a simple graph: y = x
        int x1[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};
        int y1[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};

        int x2[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};
        int y2[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};

        int x3[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};
        int y3[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};

        int x4[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};
        int y4[] = {100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260};

        int i, screen_x1, screen_y1, screen_x1_prev, screen_y1_prev;
        ...
        for (i = 1; i < 17; i++) {
            screen_x1 = x1[i]*0.5; // Scale up for visualization (example scaling factor)
            screen_y1 = y1[i]*0.5;  
            screen_x1_prev = x1[i-1]*0.5; // Scale up for visualization (example scaling factor)
            screen_y1_prev = y1[i-1]*0.5;     
            VGA_line(screen_x1_prev, screen_y1_prev, screen_x1, screen_y1, yellow);
            VGA_PIXEL(screen_x1, screen_y1, green); 

            screen_x2 = (x2[i]*0.5)+319; // Scale up for visualization (example scaling factor)
            screen_y2 = (y2[i]*0.5);  
            screen_x2_prev = (x2[i-1]*0.5)+319; // Scale up for visualization (example scaling factor)
            screen_y2_prev = (y2[i-1]*0.5);    
            VGA_line(screen_x2_prev, screen_y2_prev, screen_x2, screen_y2, cyan);
